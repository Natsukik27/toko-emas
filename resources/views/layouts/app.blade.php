...
<head>
    ...
    <!-- Styles -->
        <link rel="shortcut icon" href="{{ asset('assets/img/Natsuki Co. (1).png') }}">
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ route('admin.index') }}"><img src="{{ asset('assets/img/Natsuki Co. (2).png') }}" alt="Logo" style="height: 50px;"><b>Natsuki Co.</b></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        @if(!empty(auth()->user()->id))
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('admin.manageStock') }}">Stok</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('admin.transaksi.index') }}">Transaksi</a>
                            </li>                                                     
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('admin.laporan') }}">Laporan</a>
                            </li>
                        @endif
