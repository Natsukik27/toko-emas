                ...
                <div class="modal-content">
                    ...
                    <form method="post" action="{{ route('admin.create_produk') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- Tambahkan input untuk Berat -->
                            <div class="form-group mt-3">
                                <label for="">Berat (gram)</label>
                                <input type="number" class="form-control @error('berat') is-invalid @enderror" required
                            ...
                            <!-- Tambahkan input untuk Kadar (Karat) -->
                            <div class="form-group mt-3">
                                <label for="">Kadar (Karat)</label>
                                <input type="number" class="form-control @error('kadar') is-invalid @enderror" required
                                    value="{{ old('kadar') }}" name="kadar" id="kadar"
                                    placeholder="Masukkan kadar (karat)">
                                @error('kadar')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>

                            <!-- Tambahkan input untuk Harga per Gram -->
                            <div class="form-group mt-3">
                                <label for="">Harga per Gram</label>
                                <input type="number" class="form-control @error('harga_per_gram') is-invalid @enderror"
                                    required value="{{ old('harga_per_gram') }}" name="harga_per_gram"
                                    id="harga_per_gram" placeholder="Masukkan harga per gram">
