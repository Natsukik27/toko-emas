...
Route::get('produk/{id}', [Controllers\HomeController::class, 'showProduct'])->name('frontend.produk');
Route::get('/admin/laporan', [Controllers\LaporanController::class, 'index'])->name('admin.laporan');
Route::post('/admin/laporan/generate', [Controllers\LaporanController::class, 'generate'])->name('admin.laporan.generate');
...
Route::prefix('transaksi')->name('transaksi.')->group(function () {
    ...
    Route::get('/pembelian', [TransaksiController::class, 'create'])->name('transaksi.create');
    Route::post('/pembelian', [TransaksiController::class, 'store'])->name('transaksi.store');
});
...
Route::group(['middleware' => 'revalidate'], function () {
    ...
    Route::prefix('admin/manage-stock')->group(function () {
        Route::get('/', [App\Http\Controllers\AdminController::class, 'manageStock'])->name('admin.manageStock');
        Route::post('update/{id}', [App\Http\Controllers\AdminController::class, 'updateStock'])->name('admin.updateStock');
    });

    Route::get('admin', [App\Http\Controllers\AdminController::class, 'showGoldPrice'])->name('admin.index');

    Route::prefix('admin')->name('admin.')->group(function () {
        Route::get('transaksi', [App\Http\Controllers\AdminController::class, 'transaksiIndex'])->name('transaksi.index');
        Route::get('transaksi/create', [App\Http\Controllers\AdminController::class, 'transaksiCreate'])->name('transaksi.create');
        Route::post('transaksi', [App\Http\Controllers\AdminController::class, 'transaksiStore'])->name('transaksi.store');
    });
});
