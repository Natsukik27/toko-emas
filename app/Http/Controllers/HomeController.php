...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $produkdb = Produk::leftJoin('kategori', 'produk.id_kategori', '=', 'kategori.id')
            ->select('kategori.nama_kategori', 'produk.*'); // Semua kolom produk sudah termasuk
    ...
    public function produk(Request $request, $id)
    {
        $reqsearch = $request->get('keyword');
        $produkdb = Produk::leftJoin('kategori', 'produk.id_kategori', '=', 'kategori.id')
            ->select('kategori.nama_kategori', 'produk.*') // Semua kolom produk diambil
        ...
        $data = [
            ...
            'edit'       => $produkdb, // Kolom berat, kadar, dan harga_per_gram bisa digunakan di view
        ];
    ...
    public function showProduct($id)
    {
        ...
        return view('contents.frontend.produk', compact('produk'));
    }
